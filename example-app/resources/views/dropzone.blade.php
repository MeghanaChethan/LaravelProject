...
<section style="padding-top:90px;">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <form action="{{route('dropzone.store')}}" method="POST" accept-charset="UTF-8" 
                enctypte="multipart/form-data" class="dropzone dz-clickable" id="image-upload">
                @csrf
                <div>
